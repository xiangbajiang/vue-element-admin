...
.home .bg-white .icons :hover {
  background: #4d79f6;
}
.home .bg-white .icons :hover .icon-yonghu {
  color: white;
}
.home .bg-white .icons .iconfont {
  font-size: 60px;
}
.home .bg-white .icons .icon-yonghu {
  font-size: 60px;
  color: #4d79f6;
}
.home .bg-white .icons1:hover {
  background: #F0B600;   
}
.home .bg-white .icons1:hover .icon-xiaoxi {
  color: white;
}
.home .bg-white .icons1 .icon-xiaoxi {
  color: #F0B600;
}
.home .bg-white .icons2 :hover {
  background: #34A853;
}
.home .bg-white .icons2 :hover .icon-liuliang {
  color: white;
}
.home .bg-white .icons2 .icon-liuliang {
  color: #34A853;
}
.home .bg-white .icons3 :hover {
  background: #E2918C;
}
.home .bg-white .icons3 :hover  .icon-yanjing {
      color: white;
    }
.home .bg-white .icons3 .icon-yanjing {
  color: #E2918C;
}

.home .bg-white .icons-right {
  font-size: 24px;
  margin-top: 16px;
  margin-right: 16px;
}
.home .bg-white .icons-right .li {
  margin: 10px 0;
}
.home .bg-white .chain {
...
.home .center-left .accout {
  text-align: left;
  margin: 20px;
}
.home .center-left .tou {
  margin-bottom: 20px;
}
.home .center-left .tou img {
  width: 85px;
  height: 85px;
  border-radius: 50%;
}
.home .center-left .tou span {
  line-height: 25px;
}
.home .center-left .mobile,
.time {
  line-height: 30px;
}
.home #charts {
