...
.user-activity .user-block {
}
.user-activity .user-block .username,
.description {
  display: block;
  margin-left: 50px;
  padding: 2px 0;
...
.user-activity .user-block :after {
  clear: both;
}

.user-activity .user-block .img-circle {
  border-radius: 50%;
  width: 40px;
  height: 40px;
  float: left;
...
.user-activity .user-block span {
  font-weight: 500;
  font-size: 12px;
}

.user-activity .user-block .post {
  font-size: 14px;
...
.user-activity .user-block .post .image {
  width: 100%;
  height: 100%;
}

.user-activity .user-block .post .user-images {
  padding-top: 20px;
}

.user-activity .user-block .list-inline {
  padding-left: 0;
  margin-left: -5px;
  list-style: none;
}
.user-activity .user-block .list-inline li {
...
.user-activity .user-block .list-inline .link-black :hover,
:focus {
  color: #999;
}
